...
git push https://sreeraj-sanju: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@github.com/sreeraj-sanju/diary.git sreeraj
...
echo "${reset1}"
git push https://sreeraj-sanju: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@github.com/sreeraj-sanju/diary.git main
