<!-- Modal -->
<div wire:ignore.self class="modal fade" id="earningsUpdateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog sr-modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header sr-header">
                <h5 class="modal-title sr-title" id="exampleModalLabel">Modal title</h5>
            ...
            <div class="modal-footer sr-footer">
                ...
                <button type="button" wire:click.prevent="earnings_update()" class="btn btn-primary">Update</button>
            </div>
       </div>
    </div>
</div>