...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" ">
            <img src="data:image/png;base64,{{ chunk_split(base64_encode($logo->logo)) }}" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary" href="{{route('admin_dashboard')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('edit_settings') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item" id="accordion" data-toggle="collapse" data-target="#electronics" aria-expanded="true"
            ...
            <ul>
                <li id="electronics" class="collapse hide nav-item" aria-labelledby="headingOne"
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('actions') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('to_do_list') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
