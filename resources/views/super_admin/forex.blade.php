    ...
    <div class="content-section" id="todo">
        ...
        <div class="apps-card">
            ...
            <div class="app-card sr-card sr-card1">
                ...
                <form method="POST" action="{{route('todoUpdated')}}">
                    @csrf
                <div class="app-card__subtext">
                    <ul><li>
                        <textarea cols="110" rows="5">{{$value->desc}}</textarea></li>
                        @php
                        ...
                        <li>
                        <input class="sr-level" type="text" name="entry" placeholder="Entry point" value="{{$trade->entry}}"/>
                                    <input class="sr-level1" type="text" name="lot" placeholder="lot size" value="{{$trade->lot}}" />
                                    <input class="sr-level2" type="radio" name="type" value="0" {{$trade->type == 0 ? 'checked' : ''}}> BUY
                                    <input class="sr-level2" type="radio" name="type" value="1" {{$trade->type == 1 ? 'checked' : ''}}>SELL
                        </li>
                        @endforeach
                    </ul>
                </div>
