...
@section('content')
    <div class="content-section" id="todo">
        <div class="content-section-title">Update and become a PRO</div>
        <div class="apps-card">
            <div class="app-card sr-card">
                <span>
                ...
                <div class="app-card__subtext">
                    <ul>
                        @foreach ($data as $value)
                            <li>{{ $value->description }} <input class="todos" type="checkbox" value="{{$value->id}}" name="todos[]" {{$value->completed ? 'checked': ''}}></li>
                        @endforeach
                    </ul>
                </div>
